...
var body = { "username": "Administrator", "password": "Administrator" };
var bootstrapRequestModel = {
    ...
    appSwitchImports: ['com.modeln.AppSwitch.sale.CMnCustomSaleType.CUSTOM.label',
    ...
    enumImports: ['com.modeln.util.unit.CMnCurrency',
    ...
    dataQueryList: [{ objectName: 'PersistedSearch',
            ...
            searchTermList: [{ attribute: { name: 'UserModel',
        ...
        { moduleName: 'app',
            ...
            searchName: 'Member',
            selectList: ['Pk'],
            searchTermList: [{ operator: 'contains',
                    attribute: { name: 'MemberName', value: 'ALL_WHOLESALERS' } }] }],
    validationConfData: { validationConfSelectList: ['ConfName', 'DisplayName', 'Extends'],
        validationMsgSelectList: ['Index',
            'MsgType',
            'DisplayName',
            'FormattedMessage',
            'DefaultSeverity',
            ...
            'ValidApps',
            'IgnoreApps'],
        validationConfNames: ['BaseIndirectChargebackSaleValidation',
            'BothSaleValidation',
...
node_fetch_1["default"](baseUrl + authUrl, {
    method: "post",
...
var fetchBootstrap = function (cookie) {
    node_fetch_1["default"](baseUrl + bootstrapUrl, {
        method: "post",
        body: JSON.stringify(bootstrapRequestModel),
        headers: { "Content-Type": "application/json", cookie: cookie }
    })
        .then(function (res) { return res.json(); })
        .then(function (json) { return console.log(json); })["catch"](function (err) { return console.log(err); });
};
